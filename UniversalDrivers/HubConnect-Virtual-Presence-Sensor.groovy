...
metadata
{
	definition(name: "HubConnect Virtual Presence Sensor", namespace: "shackrat", author: "Steve White", importUrl: "https://raw.githubusercontent.com/HubitatCommunity/HubConnect/master/UniversalDrivers/HubConnect-Virtual-Presence-Sensor.groovy")
	{
...
/*
	...
	Sets the device to not present.
*/
def departed()
{
	// The server will update presence status
