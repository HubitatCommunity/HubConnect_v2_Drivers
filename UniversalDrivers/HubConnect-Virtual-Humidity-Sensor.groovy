...
metadata
{
	definition(name: "HubConnect Virtual Humidity Sensor", namespace: "shackrat", author: "Steve White", importUrl: "https://raw.githubusercontent.com/HubitatCommunity/HubConnect/master/UniversalDrivers/HubConnect-Virtual-Humidity-Sensor.groovy")
	{
		...
		command "setHumidity",				[[name:"NUMBER", type: "NUMBER"]]
		command "sync"
	}
}
...
*/
def setHumidity(Float humidity)
{
	// The server will update humidity status
	parent.sendDeviceEvent(device.deviceNetworkId, "setHumidity", [humidity])
}
