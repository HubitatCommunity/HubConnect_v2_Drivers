...
metadata
{
	definition(name: "HubConnect Shock Sensor", namespace: "shackrat", author: "Steve White", importUrl: "https://raw.githubusercontent.com/HubitatCommunity/HubConnect/master/UniversalDrivers/HubConnect-Shock-Sensor.groovy")
	{
...
def sync()
{
	...
	parent.syncDevice(device.deviceNetworkId, "shock")
