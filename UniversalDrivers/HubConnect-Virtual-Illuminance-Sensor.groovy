...
metadata
{
	definition(name: "HubConnect Virtual Illuminance Sensor", namespace: "shackrat", author: "Steve White", importUrl: "https://raw.githubusercontent.com/HubitatCommunity/HubConnect/master/UniversalDrivers/HubConnect-Virtual-Illuminance-Sensor.groovy")
	{
		...
		command "setLux",					[[name:"NUMBER", type: "NUMBER"]]
		command "sync"
	}
}
...
*/
def setLux(Integer lux)
{
	// The server will update illuminance status
	parent.sendDeviceEvent(device.deviceNetworkId, "setLux", [lux])
}
