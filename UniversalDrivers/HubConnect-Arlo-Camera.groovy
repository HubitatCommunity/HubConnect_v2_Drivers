...
metadata
{
	definition(name: "HubConnect Arlo Camera", namespace: "shackrat", author: "Steve White", importUrl: "https://raw.githubusercontent.com/HubitatCommunity/HubConnect/master/UniversalDrivers/HubConnect-Arlo-Camera.groovy")
	{
...
def sync()
{
	...
	parent.syncDevice(device.deviceNetworkId, "arlocamera")
