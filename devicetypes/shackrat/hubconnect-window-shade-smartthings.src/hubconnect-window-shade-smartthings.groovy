...
metadata
{
	definition(name: "HubConnect Window Shade SmartThings", namespace: "shackrat", author: "Steve White", ocfDeviceType: "oic.d.blind", mnmn: "SmartThings", vid: "generic-shade")
	{
