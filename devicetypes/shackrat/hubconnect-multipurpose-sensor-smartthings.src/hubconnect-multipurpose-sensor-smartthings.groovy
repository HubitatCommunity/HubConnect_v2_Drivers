...
metadata
{
	definition(name: "HubConnect Multipurpose Sensor SmartThings", namespace: "shackrat", author: "Steve White", ocfDeviceType: "oic.d.sensor", mnmn: "SmartThings", vid: "generic-contact-2")
	{
