...
metadata
{
	definition(name: "HubConnect Moisture Sensor SmartThings", namespace: "shackrat", author: "Steve White", ocfDeviceType: "oic.d.sensor", mnmn: "SmartThings", vid: "generic-leak")
	{
