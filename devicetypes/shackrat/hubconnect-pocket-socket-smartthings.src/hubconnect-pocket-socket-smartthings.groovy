...
metadata
{
	definition(name: "HubConnect Pocket Socket SmartThings", namespace: "shackrat", author: "Steve White", ocfDeviceType: "oic.d.smartplug", mnmn: "SmartThings", vid: "generic-switch-power")
	{
		capability "Switch"
