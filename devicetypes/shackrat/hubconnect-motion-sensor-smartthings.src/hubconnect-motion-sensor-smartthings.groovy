...
metadata
{
	definition(name: "HubConnect Motion Sensor SmartThings", namespace: "shackrat", author: "Steve White", ocfDeviceType: "oic.d.sensor", mnmn: "SmartThings", vid: "generic-motion")
	{
