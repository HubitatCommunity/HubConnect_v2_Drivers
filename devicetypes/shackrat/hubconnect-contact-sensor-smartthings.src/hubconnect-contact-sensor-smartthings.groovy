...
metadata
{
	definition(name: "HubConnect Contact Sensor SmartThings", namespace: "shackrat", author: "Steve White", ocfDeviceType: "oic.d.sensor", mnmn: "SmartThings", vid: "generic-contact-2")
	{
